...
class SentenceFixerSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        $sentences = [
            ...
            ['difficulty' => 'mid', 'sentence' => 'How much wood would a woodchuck chuck if a woodchuck could chuck wood?'],
            ...
            ['difficulty' => 'mid', 'sentence' => 'The diligent student studied for hours every day.'],
            ['difficulty' => 'mid', 'sentence' => 'The beautiful butterfly fluttered gracefully in the garden.'],
            ['difficulty' => 'mid', 'sentence' => 'The adventurous child explored the dense forest with curiosity.'],
            ['difficulty' => 'mid', 'sentence' => 'The talented musician played the piano with great skill and passion.'],
            ['difficulty' => 'hard', 'sentence' => 'The intricacies of quantum mechanics baffle even the most brilliant scientists.'],
            ['difficulty' => 'hard', 'sentence' => 'In a galaxy far, far away, an epic battle between good and evil raged on for centuries.'],
            ['difficulty' => 'hard', 'sentence' => 'The enigmatic philosopher pondered the meaning of existence and the nature of reality.'],
            ['difficulty' => 'hard', 'sentence' => 'The ancient manuscript contained cryptic symbols and arcane knowledge lost to time.'],
            ['difficulty' => 'hard', 'sentence' => 'The relentless pursuit of perfection often leads to burnout and disillusionment.'],
            ['difficulty' => 'hard', 'sentence' => 'The symphony of sounds in the bustling city created a cacophony of sensory experiences.'],
            ['difficulty' => 'hard', 'sentence' => 'The complex algorithm optimized the data processing speed by a significant margin.'],
            ['difficulty' => 'hard', 'sentence' => 'The intricate design of the cathedral showcased the pinnacle of Gothic architecture.'],
            ['difficulty' => 'hard', 'sentence' => 'The multifaceted nature of human emotions makes them difficult to fully comprehend.'],
            ['difficulty' => 'hard', 'sentence' => 'The expedition to the uncharted territory revealed breathtaking landscapes and diverse ecosystems.']
        ];
        foreach ($sentences as $sentence) {
            SentenceFixerSentence::create($sentence);
        }
    }
}
